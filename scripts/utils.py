"""
Utility functions for text normalization and Arabic processing.
"""
...
def normalize_arabic(text: str) -> str:
    ...
    # Optional: Normalize ta marbuta (comment out if you want to keep it)
    # text = text.replace('ة', 'ه')  # Ta marbuta to heh
